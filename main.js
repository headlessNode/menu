...
___CSS_LOADER_EXPORT___.push([module.id, `.header{
    ...
    height: 20px;
    width: 100%;
}`, "",{"version":3,"sources":["webpack://./src/menuStyle.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,YAAY;IACZ,WAAW;AACf","sourcesContent":[".header{\n    background: red;\n    height: 20px;\n    width: 100%;\n}"],"sourceRoot":""}]);
// Exports
